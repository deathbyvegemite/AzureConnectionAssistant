...
else
{
    ...
    Try 
    {
        ...
        $manifestPath = '.\Files\AzureConnectionAssistant\Module\AzureConnectionAssistant\AzureConnectionAssistant.psd1'
    ...
    Try 
    {
        ...
        $PM = @{
            Path        = '.\Files\AzureConnectionAssistant\Module\AzureConnectionAssistant'
            NuGetApiKey = $env:NuGetApiKey
            ErrorAction = 'Stop'
        }
        Publish-Module @PM
        Write-Host "AzureConnectionAssistant PowerShell Module version $newVersion published to the PowerShell Gallery." -ForegroundColor Cyan
    }
    Catch 
    {
        # Sad panda; it broke
